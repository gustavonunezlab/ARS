...
function loadMessages() {
    ...
    const recentMessagesQuery = query(collection(getFirestore(), 'messages'), orderBy('timestamp', 'desc'), limit(5));
...
var signInGoogleButtonElement = document.getElementById('sign-in-google');
